...
makeSpell_PCT("WATER_IN_BLUE", 15, {
	...
	basePotency: [
		["NEVER", 390],
		["PICTOMANCY_MASTERY_II", 460],
		["PICTOMANCY_MASTERY_III", 500],
		["PICTOMANCY_MASTERY_IV", 570],
	],
...
makeSpell_PCT("BLIZZARD_IN_CYAN", 60, {
	...
	basePotency: [
		["NEVER", 560],
		["PICTOMANCY_MASTERY_II", 680],
		["PICTOMANCY_MASTERY_III", 750],
		["PICTOMANCY_MASTERY_IV", 860],
	],
...
const hammerInfos: Array<[PCTActionKey, number, number | Array<[TraitKey, number]>, number]> = [
	[
		...
		[
			["NEVER", 420],
			["PICTOMANCY_MASTERY_II", 500],
			["PICTOMANCY_MASTERY_III", 540],
