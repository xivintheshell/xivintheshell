...
import { ResourceType, WarningType, TankLBResourceType } from "../Common";
...
makeAbility(TANK_JOBS, "INTERJECT", 18, ResourceType.cd_HeadGraze, {
	applicationDelay: 0,
	cooldown: 30,
	assetPath: "Role/Interject.png",
});

makeAbility(RANGED_JOBS, "HEAD_GRAZE", 24, ResourceType.cd_HeadGraze, {
	applicationDelay: 0,
	cooldown: 30,
...
makeResourceAbility(TANK_JOBS, "REPRISAL", 22, ResourceType.cd_Reprisal, {
...
makeResourceAbility(MELEE_JOBS, "FEINT", 22, ResourceType.cd_Feint, {
...
makeResourceAbility(CASTER_JOBS, "ADDLE", 8, ResourceType.cd_Addle, {
...
makeResourceAbility(TANK_JOBS, "RAMPART", 8, ResourceType.cd_Rampart, {
...
makeResourceAbility(MELEE_JOBS, "TRUE_NORTH", 50, ResourceType.cd_TrueNorth, {
...
makeResourceAbility([...HEALER_JOBS, ...CASTER_JOBS], "SWIFTCAST", 18, ResourceType.cd_Swiftcast, {
...
makeResourceAbility([...HEALER_JOBS, ...CASTER_JOBS], "SURECAST", 44, ResourceType.cd_Surecast, {
...
makeResourceAbility(MELEE_JOBS, "BLOODBATH", 8, ResourceType.cd_Bloodbath, {
...
makeAbility([...MELEE_JOBS, ...RANGED_JOBS], "SECOND_WIND", 12, ResourceType.cd_SecondWind, {
	applicationDelay: 0.625,
	cooldown: 120,
...
makeAbility(TANK_JOBS, "PROVOKE", 15, ResourceType.cd_Provoke, {
	applicationDelay: 0,
	cooldown: 30,
	assetPath: "Role/Provoke.png",
});

makeAbility(TANK_JOBS, "SHIRK", 48, ResourceType.cd_Shirk, {
	applicationDelay: 0,
	cooldown: 120,
	assetPath: "Role/Shirk.png",
});

makeAbility(TANK_JOBS, "LOW_BLOW", 25, ResourceType.cd_LowBlow, {
	applicationDelay: 0.62,
	cooldown: 25,
...
makeAbility(HEALER_JOBS, "RESCUE", 48, ResourceType.cd_Rescue, {
	applicationDelay: 0, // Who knows
	cooldown: 120,
	assetPath: "Role/Rescue.png",
});

makeAbility(MELEE_JOBS, "LEG_SWEEP", 10, ResourceType.cd_LegSweep, {
	applicationDelay: 0.625,
	cooldown: 40,
...
makeResourceAbility(ALL_JOBS, "TINCTURE", 1, ResourceType.cd_Tincture, {
...
makeResourceAbility(ALL_JOBS, "SPRINT", 1, ResourceType.cd_Sprint, {
...
makeLimitBreak(TANK_JOBS, "SHIELD_WALL", ResourceType.cd_TankLB1, {
	tier: "1",
...
makeLimitBreak(TANK_JOBS, "STRONGHOLD", ResourceType.cd_TankLB2, {
	tier: "2",
...
// Healer
makeLimitBreak(HEALER_JOBS, "HEALING_WIND", ResourceType.cd_HealerLB1, {
	tier: "1",
	castTime: 2,
	applicationDelay: 0.76,
	animationLock: 2.1,
});
makeLimitBreak(HEALER_JOBS, "BREATH_OF_THE_EARTH", ResourceType.cd_HealerLB2, {
	tier: "2",
	castTime: 2,
...
// Melee
makeLimitBreak(MELEE_JOBS, "BRAVER", ResourceType.cd_MeleeLB1, {
	tier: "1",
	castTime: 2,
...
makeLimitBreak(MELEE_JOBS, "BLADEDANCE", ResourceType.cd_MeleeLB2, {
	tier: "2",
	castTime: 3,
...
// Ranged
makeLimitBreak(RANGED_JOBS, "BIGSHOT", ResourceType.cd_RangedLB1, {
	tier: "1",
	castTime: 2,
	applicationDelay: 2.23,
	animationLock: 3.1,
...
makeLimitBreak(RANGED_JOBS, "DESPERADO", ResourceType.cd_RangedLB2, {
	tier: "2",
	castTime: 3,
...
// Caster
makeLimitBreak(CASTER_JOBS, "SKYSHARD", ResourceType.cd_CasterLB1, {
	tier: "1",
	castTime: 2,
...
makeLimitBreak(CASTER_JOBS, "STARSTORM", ResourceType.cd_CasterLB2, {
	tier: "2",
	castTime: 3,
