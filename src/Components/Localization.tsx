...
const modifierNames = new Map<PotencyModifierType, LocalizedContent>([
	...
	[PotencyModifierType.HONED_STEEL, { en: "honed steel" }],
	[PotencyModifierType.HONED_REAVERS, { en: "honed reavers" }],
	[PotencyModifierType.HINDSTUNG_VENOM, { en: "hindstung venom" }],
	[PotencyModifierType.HINDSBANE_VENOM, { en: "hindsbane venom" }],
	[PotencyModifierType.FLANKSBANE_VENOM, { en: "flanksbane venom" }],
	[PotencyModifierType.FLANKSTUNG_VENOM, { en: "flankstung venom" }],
	[PotencyModifierType.GRIMSKINS_VENOM, { en: "grimskin's venom" }],
	[PotencyModifierType.GRIMHUNTERS_VENOM, { en: "grimhunter's venom" }],
	[PotencyModifierType.HUNTERS_VENOM, { en: "hunter's venom" }],
	[PotencyModifierType.SWIFTSKINS_VENOM, { en: "swiftskin's venom" }],
	[PotencyModifierType.FELLHUNTERS_VENOM, { en: "fellhunter's venom" }],
	[PotencyModifierType.FELLSKINS_VENOM, { en: "fellskin's venom" }],
	[PotencyModifierType.POISED_FOR_TWINFANG, { en: "poised for twinfang" }],
	[PotencyModifierType.POISED_FOR_TWINBLOOD, { en: "poised for twinblood" }],
]);
...
const modifierTags = new Map<PotencyModifierType, LocalizedContent>([
	...
	[PotencyModifierType.HONED_STEEL, { en: "HONE" }],
	[PotencyModifierType.HONED_REAVERS, { en: "HONE" }],
	[PotencyModifierType.HINDSTUNG_VENOM, { en: "VENOM" }],
	[PotencyModifierType.HINDSBANE_VENOM, { en: "VENOM" }],
	[PotencyModifierType.FLANKSBANE_VENOM, { en: "VENOM" }],
	[PotencyModifierType.FLANKSTUNG_VENOM, { en: "VENOM" }],
	[PotencyModifierType.GRIMSKINS_VENOM, { en: "VENOM" }],
	[PotencyModifierType.GRIMHUNTERS_VENOM, { en: "VENOM" }],
	[PotencyModifierType.HUNTERS_VENOM, { en: "VENOM" }],
	[PotencyModifierType.SWIFTSKINS_VENOM, { en: "VENOM" }],
	[PotencyModifierType.FELLHUNTERS_VENOM, { en: "VENOM" }],
	[PotencyModifierType.FELLSKINS_VENOM, { en: "VENOM" }],
	[PotencyModifierType.POISED_FOR_TWINFANG, { en: "POISE" }],
	[PotencyModifierType.POISED_FOR_TWINBLOOD, { en: "POISE" }],
]);
