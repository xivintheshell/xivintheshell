...
const modifierNames = new Map<PotencyModifierType, LocalizedContent>([
	...
	[PotencyModifierType.WHISTLE, { en: "Whistle", zh: "口笛" }],
	[PotencyModifierType.BRISTLE, { en: "Bristle", zh: "蓄力" }],
...
const modifierTags = new Map<PotencyModifierType, LocalizedContent>([
	...
	[PotencyModifierType.TINGLEA, { en: "Tingle", zh: "哔哩哔哩" }],
	[PotencyModifierType.TINGLEB, { en: "Tingle", zh: "哔哩哔哩" }],
	[PotencyModifierType.WINGEDREPROBATION, { en: "Winged Reprobation", zh: "断罪飞翔" }],
	[PotencyModifierType.WINGEDREDEMPTION, { en: "Winged Redemption", zh: "完美神的祝福" }],
]);
