...
const skillsZh = new Map<ActionKey, string>([
	...
	// WAR
	[SkillName.HeavySwing, "重劈"],
	[SkillName.Maim, "凶残裂"],
	[SkillName.StormsPath, "暴风斩"],
	[SkillName.StormsEye, "暴风碎"],
	[SkillName.FellCleave, "裂石飞环"],
	[SkillName.Upheaval, "动乱"],
	[SkillName.Onslaught, "猛攻"],
	[SkillName.Tomahawk, "飞斧"],
	[SkillName.Overpower, "超压斧"],
	[SkillName.MythrilTempest, "秘银暴风"],
	[SkillName.Decimate, "地毁人亡"],
	[SkillName.Orogeny, "群山隆起"],
	[SkillName.InnerRelease, "原初的解放"],
	[SkillName.PrimalWrath, "原初的怒震"],
	[SkillName.PrimalRend, "蛮荒崩裂"],
	[SkillName.PrimalRuination, "尽毁"],
	[SkillName.Infuriate, "战嚎"],
	[SkillName.InnerChaos, "狂魂"],
	[SkillName.ChaoticCyclone, "混沌旋风"],
	[SkillName.ThrillOfBattle, "战栗"],
	[SkillName.Equilibrium, "泰然自若"],
	[SkillName.ShakeItOff, "摆脱"],
	[SkillName.RawIntuition, "原初的直觉"],
	[SkillName.NascentFlash, "原初的勇猛"],
	[SkillName.BloodWhetting, "原初的血气"],
	[SkillName.Vengeance, "复仇"],
...
const resourcesZh = new Map<ResourceKey, string>([
	...
	[ResourceType.HighThunder, "高闪雷"],
	[ResourceType.ThunderIII, "暴雷"],
	[ResourceType.HighThunderII, "高震雷"],
	[ResourceType.ThunderIV, "霹雷"],
	...
	[ResourceType.DeathsDesign, "死亡烙印debuff"],
	...
	[ResourceType.Bioblaster, "毒菌冲击dot"],
	[ResourceType.Tactician, "策动buff"],
	...
	// WAR
	[ResourceType.SurgingTempest, "战场风暴buff"],
	[ResourceType.InnerRelease, "原初的解放buff"],
	[ResourceType.InnerStrength, "原初的觉悟buff"],
	[ResourceType.BurgeoningFury, "原初的搏动buff"],
	[ResourceType.Wrathful, "原初的怒震预备"],
	[ResourceType.PrimalRendReady, "蛮荒崩裂预备"],
	[ResourceType.PrimalRuinationReady, "尽毁预备"],
	[ResourceType.NascentChaos, "原初的混沌buff"],
	[ResourceType.NascentFlash, "原初的勇猛buff（给队友）"],
	[ResourceType.ThrillOfBattle, "战栗"],
	[ResourceType.Equilibrium, "泰然自若的hot"],
	[ResourceType.ShakeItOff, "摆脱的盾"],
	[ResourceType.ShakeItOffOverTime, "摆脱的hot"],
	[ResourceType.RawIntuition, "原初的直觉buff"],
	[ResourceType.StemTheTide, "原初的血烟（挡伤害buff）"],
	[ResourceType.StemTheFlow, "原初的勇猛buff（给队友）"],
	[ResourceType.Bloodwhetting, "原初的血气（吸血buff）"],
	[ResourceType.Vengeance, "复仇减伤30"],
	[ResourceType.Damnation, "戮罪减伤40"],
	[ResourceType.PrimevalImpulse, "讨罪hot"],
	[ResourceType.Holmgang, "死斗buff"],
	[ResourceType.Defiance, "盾姿buff"],
	[ResourceType.BeastGauge, "兽魂量谱"],
	[ResourceType.StormCombo, "单体连击"],
	[ResourceType.TempestCombo, "aoe连击"],
	[ResourceType.Reprisal, "雪仇buff"],
	[ResourceType.Rampart, "铁壁buff"],
	[ResourceType.ShieldWall, "一段LB buff"],
