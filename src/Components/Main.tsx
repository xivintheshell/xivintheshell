...
export default class Main extends React.Component {
	...
	render() {
		...
		let mainControlRegion = (
			<div style={{ flex: 7, display: "inline-block", position: "relative" }}>
				<div
					onFocus={() => {
										...
										en: (
											<>
												<p>
													...
													. It unites BLM and PCT in the Shell, has
													preliminary RDM support, and might support more
													jobs in the future.
												</p>
												<p>
													Patch 7.1 job changes as well as future updates
													will all happen on the new site, so see y'all
													over there :)
												</p>
											</>
										),
								...
								{containsEwCacheContent() ? (
									...
									>
										{localize({
											en: (
												<div>
													NOTE: Your browser cache contains data from BLM
													in the Shell before it's updated for Dawntrail.
													Visit the Endwalker archive at{" "}
													<a
													...
													to access and automatically re-save it. Once you
													do that, this notice will also go away.
												</div>
											),
											zh: (
												<div>
