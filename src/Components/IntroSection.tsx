							...
							{localize({
								en: <div>
									<div className="paragraph">
										...
										record files aren't loading properly but you don't understand why, contact me
										and I'll try my best to help.
									</div>
									<div className="paragraph">
										If the browser cache is somehow messed up (likely due to invalid game states),
										this is how to reset it:<br/>
										Enter this tool
										from <b>{THIS_DOMAIN + "/#/{command}"}</b> replacing <b>{"{command}"}</b> with
										one of the following:
										<ul>
											<li style={smallGap}><b>resetResourceOverrides</b>: delete all resource
												overrides and all actions on the current timeline.
											</li>
											<li style={smallGap}><b>resetAll</b>: delete all browser-cached settings.
											</li>
										</ul>
									</div>
								</div>,
								...
								ja: <div>
									...
									<div className="paragraph">
										...
										<ul>
											<li style={smallGap}><b>resetResourceOverrides</b>:
												全てのリソースとタイムライン上のアクションを上書きします。
											</li>
											<li style={smallGap}><b>resetAll</b>: 全てのブラウザキャッシュを削除します。
											</li>
										</ul>
									</div>
								</div>,
			...
			content={<div>
				...
				{localize({
					en: <ul>
						...
						<li><a href={"https://na.finalfantasyxiv.com/jobguide/battle/"}>Official FFXIV job guides</a></li>
