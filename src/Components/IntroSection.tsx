									...
									{localize({
										en: <div>
											...
											<div className="paragraph">
												...
												<b>{THIS_DOMAIN + "/command/{command}"}</b> replacing{" "}
										...
										zh: <div>
											...
											<div className="paragraph">
												...
												<br />
												用以下链接进入本工具：
												<b>{THIS_DOMAIN + "/command/{command}"}</b>，然后把
										...
										ja: <div>
											...
											<div className="paragraph">
												...
												<br />
												<b>{THIS_DOMAIN + "/command/{command}"}</b> にアクセスし、
												<b>{"{command}"}</b>{" "}
												を以下のいずれかに置き換えます：
												<ul>
													<li style={smallGap}>
