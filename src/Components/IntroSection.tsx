					...
					<>
						<div>
							{changelog.map((entry) => {
								...
								return (
									<div className={"paragraph"} key={entry.date}>
										{entry.date}
										<br />
										{changes}
									</div>
						...
						<div>
							For older changelog entries before the BLM/PCT in the Shell rejoining,
							see the old sites:&nbsp;
							<a
								target={"_blank"}
								rel={"noreferrer"}
	...
	<>
		...
		{localize({
			en: (
				<ul>
					<li>
						<b>Eshiya (Galahad Donnadieu @ Exodus)</b>: the PM and the big brain BLM
					</li>
					<li>
						<b>miyehn (Ellyn Waterford @ Sargatanas)</b>: initial software developer and
						a humble BLM student
					</li>
					<li>
						<b>Turtle</b>, who did the heavy work of updating this tool from Endwalker
						to Dawntrail
					</li>
					<li>
						<b>shanzhe (Shanzhe Qi @ Seraph)</b>, who created PCT in the Shell and the
						framework for adding other jobs to this tool
					</li>
					<li>
						<b>Yara, Spider, Santa, Akairyu</b>, and many other players who contributed
						feature suggestions, timeline markers, bug reports, etc.
					</li>
				</ul>
			),
			zh: (
				<ul>
					<li>
						<b>Eshiya（加拉哈德 @ 沃仙曦染）</b>：PM；是个真黑魔玩家
					</li>
					<li>
						<b>miyehn（米岩 @ 海猫茶屋，国服长草中）</b>：最初的程序；是个云黑魔玩家
					</li>
					<li>
						<b>Turtle</b>, 把本工具从6.0更新到7.0的大功臣
					</li>
					<li>
						<b>shanzhe</b>, 画家排轴器作者；为让本工具支持更多职业而搭建了程序框架
					</li>
					<li>
						<b>Yara, Spider, Santa, Akairyu</b>{" "}
						等，以体验反馈、报bug、时间轴标记等形式为这个工具作出过无私贡献的玩家们
					</li>
				</ul>
			),
			ja: (
				<ul>
					...
					<li>
						<b>Eshiya (Galahad Donnadieu @ Exodus)</b>:
						プロダクトマネージャー、凄腕黒魔道士
					</li>
					<li>
						<b>miyehn (Ellyn Waterford @ Sargatanas)</b>:
						ソフトウェア開発者、しがない黒魔道士
					</li>
					<li>
						<b>Turtle</b>: 黄金のレガシーへのアップデートを担当
					</li>
					<li>
						<b>Yara, Spider, Santa, shanzhe, Akairyu</b>{" "}
						そして新機能やバグ報告などで貢献してくださった多くのFF14プレーヤーの皆さん
					</li>
				</ul>
			),
		})}
		...
		{localize({
			en: (
				<div className={"paragraph"}>
					...
					(requires the "Misc. Support" role). You can also find me directly on discord
					(miyehn), or via email (ellyn.waterford@gmail.com). In case of sending a bug
					report, attaching the fight record (download "fight.txt" from the bottom or name
					it anything else) would be very helpful.
				</div>
			),
			zh: (
				<div className={"paragraph"}>
					...
					<div>
						...
						{localize({
							en: (
								<ul>
									...
									<li style={smallGap}>
										Click on a skill to use it. If it's not ready yet, click on
										it again will wait and retry.
									</li>
									<li style={smallGap}>
										Press <ButtonIndicator text={"u"} /> to delete the last
										added action (effective when not running in real-time).
									</li>
									<li style={smallGap}>
										Click on a buff applied to self to remove it. Unless it's
										ley lines, in which case it can be re-enabled.
									</li>
								</ul>
							),
							zh: (
						...
						{localize({
							en: (
								<ul>
									...
									<li style={smallGap}>
										Click to select a skill on the timeline. Shift click to
										select a sequence of skills
									</li>
									<li style={smallGap}>
										<ButtonIndicator text={"backspace"} /> or{" "}
										<ButtonIndicator text={"delete"} /> to delete the selected
										skill and everything after it
									</li>
									<li style={smallGap}>
										Click on the timeline's ruler-like header to view historical
										game states. While doing so, the main control region will
										have an <b style={{ color: "darkorange" }}>orange</b> border
										and you will not be able to use skills. Click on somewhere
										else on the timeline to cancel.
									</li>
								</ul>
							),
							zh: (
						...
						{localize({
							en: (
								<div className={"paragraph"}>
									...
									are file download links. Click to download, or right click to
						...
						{localize({
							en: (
								<div className="paragraph">
									...
									<b>Import/Export</b> tab. Most edits are also automatically
									saved in your browser cache, so it's generally okay to refresh
									the page and not worry about losing progress.
								</div>
							),
							zh: (
								<div className="paragraph">
						...
						{localize({
							...
							zh: (
								<div className="paragraph">
									鼠标悬浮在各处的{" "}
									<Help topic={"sampleTips"} content={"我是一个说明"} />{" "}
									上查看更多使用说明。
								</div>
							),
							ja: (
											...
											en: (
												<div>
													<div className="paragraph">
														...
														backward compatible. If your fight record
														files aren't loading properly but you don't
														understand why, contact me and I'll try my
														best to help.
													</div>
													<div className="paragraph">
														If the browser cache is somehow messed up
														(likely due to invalid game states), this is
														how to reset it:
														<br />
														Enter this tool from{" "}
														<b>{THIS_DOMAIN + "/#/{command}"}</b>{" "}
														replacing <b>{"{command}"}</b> with one of
														the following:
														<ul>
															<li style={smallGap}>
																<b>resetResourceOverrides</b>:
																delete all resource overrides and
																all actions on the current timeline.
															</li>
															<li style={smallGap}>
																<b>resetAll</b>: delete all
																browser-cached settings.
															</li>
														</ul>
													</div>
												</div>
							...
							en: (
								<ul>
									...
									<li>
										...
										: a snapshot of this tool at the end of Endwalker. It also
										contains some notable fight plans from Endwalker, as memoir.
									</li>
									<li>
									...
									<li>
										...
										<a href={"https://www.thebalanceffxiv.com/"}>job guides</a>{" "}
										and <a href={BALANCE_URL}>Discord</a>
									</li>
								</ul>
							),
							zh: (
								...
								<ul>
									{
										/*[outdated (ja)]*/ <>
											...
											<li>
												<a
													href={
														"https://spide-r.github.io/ffxiv-blm-rotation/"
													}
												>
													Black Mage in the Bozjan Shell
												</a>
