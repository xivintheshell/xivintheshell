...
export function Clickable(props: ClickableProps) {
	return (
		<div className={"clickable"} onClick={props.onClickFn} style={props.style}>
			{props.content}
		</div>
	);
}
...
export class Input extends React.Component {
	...
	render() {
		...
		return (
			<div style={{ ...overrideStyle, ...{ color: this.props.componentColor } }}>
...
export class Expandable extends React.Component {
	...
	render() {
		let indentDivStyle = this.autoIndent
			...
			: {};
		return (
			<div style={this.props.noMargin ? {} : { marginTop: 10, marginBottom: 10 }}>
				<Clickable
					content={
						<span>
