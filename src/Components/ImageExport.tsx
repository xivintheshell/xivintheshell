			...
			<div>
				<p>
					{localize({
						en: (
							<span>
								export the selected part of the timeline as a png according to the
								current display settings, or the whole timeline if nothing is
								selected
							</span>
						),
