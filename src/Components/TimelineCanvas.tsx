...
function drawSkills(
	...
	const coverInfo: Map<BuffType, { color: string; showImage: boolean }> = new Map([
		...
		[BuffType.PowerSurge, { color: g_colors.brd.wanderersCoda, showImage: true }],
		[BuffType.LanceCharge, { color: g_colors.brd.ragingStrikes, showImage: true }],
		[BuffType.LifeOfTheDragon, { color: g_colors.sam.fugetsu, showImage: true }],
		[BuffType.BattleLitany, { color: g_colors.brd.magesCoda, showImage: true }],
		[BuffType.EnhancedPiercingTalon, { color: g_colors.sam.fugetsu, showImage: true }],
