...
it("simulates 7.05 standard opener correctly", testWithConfig({}, () => {
    [
        SkillName.Tomahawk, SkillName.Infuriate,
        SkillName.HeavySwing,
        SkillName.Maim,
        SkillName.StormsEye, SkillName.InnerRelease,
        SkillName.InnerChaos, SkillName.Upheaval, SkillName.Onslaught,
        SkillName.PrimalRend, SkillName.Onslaught,
        SkillName.PrimalRuination, SkillName.Onslaught,
        SkillName.FellCleave,
        SkillName.FellCleave,
        SkillName.FellCleave, SkillName.PrimalWrath, SkillName.Infuriate,
        SkillName.InnerChaos,
        SkillName.HeavySwing,
        SkillName.Maim,
        SkillName.StormsPath,
        SkillName.FellCleave, SkillName.Infuriate,
        SkillName.InnerChaos,
    ].forEach(applySkill);
    ...
    compareDamageTables([
        ...
        {
            skillName: SkillName.Maim,
            displayedModifiers: [PotencyModifierType.COMBO, PotencyModifierType.SURGING_TEMPEST],
            hitCount: 1,
        },
        {
        ...
        },
        {
            ...
            displayedModifiers: [PotencyModifierType.AUTO_CDH, PotencyModifierType.SURGING_TEMPEST],
            hitCount: 3,
        },
        {
        ...
        {
            skillName: SkillName.FellCleave,
            displayedModifiers: [PotencyModifierType.SURGING_TEMPEST, PotencyModifierType.AUTO_CDH],
            hitCount: 3,
        },
        {
...
it("Tracks surging tempest correctly", testWithConfig({}, () => {
    [
        SkillName.Overpower,
        SkillName.Onslaught,
        SkillName.MythrilTempest,
    ].forEach(applySkill);
    const state = controller.game as WARState;
